...
final List <String> advise = [
  ...
  "Nawet jedna sesja zmęczenia fizycznego może wyzwolić endorfiny i polepszyć Twój nastrój.",
  "Opisz swoje uczucia na papierze lub w aplikacji do notowania.",
  "Sauna i szok termiczny pomagają wyzwolić endorfiny i poprawić nastrój.",
  "Porozmawiaj z kimś, komu ufasz - nawet krótka rozmowa może wiele zmienić.",
  "Zadbaj o podstawy: sen, nawodnienie i regularne posiłki to fundament dobrego samopoczucia.",
  "Pobądź chwilę w naturze - spacer po parku lub lesie może przynieść ukojenie.",
  "Unikaj izolacji - obecność drugiego, trzeźwego człowieka potrafi działać kojąco.",
  "Spróbuj zmienić otoczenie - czasem wyjście z domu może pomóc spojrzeć na sprawy inaczej.",
  "Stwórz plan działania na najbliższe godziny, by odzyskać poczucie kontroli.",
  "Przypomnij sobie, dlaczego chcesz trzeźwieć.",
  "Skup się na jednej małej rzeczy, którą możesz zrobić tu i teraz. Skorzystaj z Narzędzi", 
  "Włącz ulubioną muzykę - dźwięki potrafią wpływać na nastrój.",
  "Pozwól sobie na przerwę - odpoczynek to nie lenistwo, to troska o siebie.",
  "Zrób coś kreatywnego - rysowanie, pisanie lub gotowanie może być terapeutyczne. Skorzystaj z Narzędzi!",
  "Przytulenie kogoś bliskiego lub nawet zwierzaka może zredukować napięcie.",
  "Pomyśl o trzech rzeczach, za które jesteś dziś wdzięczny.",
  "Spróbuj techniki oddechowej - kilka głębokich oddechów może pomóc się uspokoić.",
  "Zachowuj łagodność wobec siebie - to, co czujesz, jest ważne i zasługuje na zrozumienie. Zapisz i przeczytaj to później.",
  "Zastosuj zasadę HALT - głód, złość, samotność, zmęczenie - rozpoznaj, co naprawdę czujesz.",
  "Przypomnij sobie, dlaczego zacząłeś proces zdrowienia - twoje powody są ważne.",
  "Zadbaj o rutynę dnia - struktura pomaga utrzymać trzeźwość.",
  "Napisz, co czujesz - wyrzucenie emocji na papier może zapobiec nawrotowi.",
  "Unikaj miejsc, ludzi i sytuacji, które kojarzą się z używaniem.",
  "Nie musisz przechodzić przez to sam - sięgnij po pomoc, zanim będzie za późno.",
  "Trzeźwość to nie kara - to droga do prawdziwej wolności i spokoju.",
  "Zadzwoń do kogoś, kto rozumie, przez co przechodzisz - kontakt leczy.",
  "Zamiast uciekać w nawyk, poszukaj, co naprawdę chcesz poczuć i dlaczego.",
  "To, co czujesz teraz, minie - nie podejmuj decyzji pod wpływem impulsu.",
  "Przypomnij sobie, że głód substancji trwa tylko kilka minut - możesz to przetrwać.",
  "Zrób listę tego, co straciłeś przez używanie - i co odzyskałeś dzięki trzeźwości.",
  "Każdy dzień trzeźwości to dowód na to, że jesteś silniejszy, niż myślisz.",
  "Grupa wsparcia to bezpieczne miejsce - nie izoluj się, kiedy jest Ci trudno.",
  "Masz prawo do pomocy - nie musisz cierpieć w milczeniu.",
];
